...
# จาก assignment 1 มีช่องโหว่เยอะมากไม่ว่าจะเป็น xss attack หรือ บันทึกรายการชื่อเดียว และ เวลาเดียวกันได้ ทั้งที่มันไม่ควร หรือ อะไรต่างๆ เพราะเกิดจากความความสะเพร่าของผมที่ลืม validate ผมเลยทำการแก้ไขใน assignment 2 แทนเพราะผมทำ assignment 1 เสร็จไปแล้วผมถือว่าตัวเองส่งไปแล้ว ผมเลยไม่กลับไปแก้ใน assignment 1 แต่ แก้ไขให้ครบและ ถี่ถ้วน ใน assignment 2 แทน
